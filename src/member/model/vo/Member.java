...
public class Member {
	...
	public Member(int user_no, String user_id, String user_password, String user_name, String user_nickName,
			String user_email, String address, Date hireDate, int grade, String status, String phone) {
		super();
	...
	public Member(String user_id, String user_name, String user_email, String address, String phone) {
		super();
		this.user_id = user_id;
		this.user_name = user_name;
		this.user_email = user_email;
	...
	public String toString() {
		return "Member [user_no=" + user_no + ", user_id=" + user_id + ", user_password=" + user_password
				...
				+ ", address=" + address + ", hireDate=" + hireDate + ", grade=" + grade + ", status=" + status
				+ ", phone=" + phone + "]";
	}
