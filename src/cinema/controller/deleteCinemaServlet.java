...
/**
 * Servlet implementation class deleteCinemaServlet
 */
@WebServlet("/deleteCinema.ci")
public class deleteCinemaServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("deleteServlet으로 넘어오는데 성공");
		int result = new CinemaService().deleteCinema(no);
