...
/**
 * Servlet implementation class coupleServlet
 */
@WebServlet("/couple.ci")
public class coupleServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//서비스 여러번 사용해주니까 별도로 생성필요
				...
				// 리스트를 불러와서 뿌려줘야함
				ArrayList<Cinema> clist = cService.selectCList(2);
				String page = null;
				String theme = "연인";
				String comment = "연인과 함께 가기 좋은 영화관";
				//영화관정보
				if(clist != null) {
