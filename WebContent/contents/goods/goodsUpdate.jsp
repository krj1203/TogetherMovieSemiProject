<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="goods.model.vo.*"%>
<%
...
<body>
    ...
    <%@include file="../common/loginbar.jsp" %>
		...
		<%@include file="../common/header.jsp" %>
			    	<!-- 상품 상세 정보 -->
			<form action="<%= request.getContextPath() %>/goodsUpdate.gs" method="post" encType="multipart/form-data">
			<input type="hidden" name="gNo" value="<%= g.getGoods_no() %>">
			<div class="pro">
				<div class="product_view">
					<table>
						<tr>
							<th width="100px">제목</th>
							<td colspan="3"><input type="text" size="15" name="title" value="<%= g.getGoods_title() %>"></td>
						</tr>
						<tr>
							<th width="100px">가격</th>
							<td colspan="3"><input type="number" size="15" name="price" value="<%= g.getGoods_price() %>"></td>
						</tr>
						<tr>
							<th width="100px">상품 설명</th>
							<td colspan="3"><textarea name="content" rows="5" cols="50" style="resize:none;"><%= g.getGoods_contents() %></textarea>
						</tr>
					<tr>
						<th>대표 이미지</th>
						<td colspan="3">
							<div id="titleImgArea">
								<img id="titleImg" width="350" height="200" src="<%= request.getContextPath() %>/goods_uploadFiles/<%= gi.getChangeName()%>">
							</div>
						</td>
					</tr>
					<tr>
