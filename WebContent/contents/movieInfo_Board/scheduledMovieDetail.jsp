...
<body>
	...
	<div class="movieInfo_view">
		...
		<div class="img">
			<img src="<%= request.getContextPath() %>/scheduledMovie_uploadFiles/<%= titleImg.getChangeName()%>">
		</div>
				...
				<%for(int i=1; i<fileList.size(); i++){ %>
					<td>
						<div class="stillShotImgArea">
							 	<img id="stillShotImg<%=i%>" class="stillShotImg" src="<%=request.getContextPath() %>/scheduledMovie_uploadFiles/<%=fileList.get(i).getChangeName() %>">
						</div>
					</td>
				<%} %>
		</table>
