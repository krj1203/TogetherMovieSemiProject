...
<body>
    ...
    <%@include file="../common/loginbar.jsp" %>
		...
		<%@include file="../common/header.jsp" %>
			...
			<form action="<%= request.getContextPath() %>/lMovieInsert" method="post" encType="multipart/form-data">
			<div class="movieInfo">
				<div class="movieInfo_view">
					...
					<div class="btns">
						...
						<input type="button" class="btn2" id="cancelBtn" onclick="location.href='<%= request.getContextPath() %>/listLMovie'" value="취소하기">
					</div>
				</div>
			</div>
			</form>
