...
<body>
  <c:set var="user_id" value="${sessionScope.loginUser.user_id }"></c:set>
  <c:set var="user_nickName" value="${sessionScope.loginUser.user_nickName }"></c:set>
  <c:set var="user_name" value="${sessionScope.loginUser.user_name }"></c:set>
  <c:set var="phone" value="${sessionScope.loginUser.phone }"></c:set>
  <c:set var="user_email" value="${sessionScope.loginUser.user_email }"></c:set>
  <c:set var="user_address" value="${sessionScope.loginUser.address }"></c:set>
					...
					<table>
						...
						<tbody>
							...
							<tr style="border:5px solid blue;">
								<th><span>닉네임</span></th>
								<td><c:out value="${user_nickName}" /></td>
