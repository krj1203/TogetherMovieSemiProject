...
<%
	...
	BoardInfo QbiList = (BoardInfo)request.getAttribute("QbiList");
				...
				<table id="bulletin">
						...
						<tr>
							<td scope="col" colspan="3">
								<input type="hidden" name="bNo" value="<%= qboard.getBoardNo() %>">
								<input type="hidden" size="80" name="title" value="<%= qboard.getBoardTitle() %>">
								<%= qboard.getBoardTitle() %>
							</td>
							<!-- 
							<td>
						...
						<tr>
							<td colspan="3">
								<% if(QbiList != null){ %>
									<img id = "image" src="<%= request.getContextPath() %>/BoardInfo_uploadFiles/<%= QbiList.getChangeName() %>">
									<br><br>
								<% } %>
