	    	 	...
	    	 	<form action="<%= request.getContextPath() %>/insert.bo" method="post">
					<table id="writeBoard">
						...
						<tr class="row1">
							...
							<td id="tb2">
								<textarea class="textBox" name="title" cols="70" rows="1" style="resize:none;"></textarea>
							</td>
						</tr>
						<tr>
							<td id="tb1">내용</td>
							<td id="tb3">
								<textarea class="textBox" name="content" cols="70" rows="15" style="resize:none;"></textarea>
							</td>
						</tr>
					</table>
